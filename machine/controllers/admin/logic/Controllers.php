...
class Controllers {
    ...
    public static function getControllers() {
        ...
        $requests = CacheManager::get("requests");
        $request_task = CacheManager::get("request_task");

        foreach ($request_task as $id => $entity) {
            $requests[$entity['request_id']]['task_id'] = $entity['task_id'];
        }

        Status::message(Status::SUCCESS, array_values($requests));
    }
